...
<x-card class="shadow-md">
    ...
    <x-form wire:submit='save' id="form-item" class="grid-cols-1 md:grid-cols-2">
        ...
        <x-datepicker class="border-gray-600 focus:border-gray-600 focus:outline-gray-600" label="Tanggal Register" icon="o-calendar" :config="['altFormat' => 'd M Y']" wire:model="form.tanggal_register" />
    ...
    <x-slot:actions>
        ...
        <x-button label="Create" form="form-item" type="submit" class="text-white bg-gray-800 btn" spinner="save" />
    </x-slot:actions>
</x-card>
